...
public:
    ...
    bool had_extend(CPN *cpn,Config *C,PE *pe, bool is_readT=false,set<index_t > read_varB={});
...
public:
    ...
    void getheur(Heuristic *heur){ this->heur=heur;};
    void init();
    void unfolding(SYNCH *synch,Heuristic *heur);
